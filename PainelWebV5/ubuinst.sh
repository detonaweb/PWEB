...
exit;
  ...
  echo -e 'by: @DETONAWEBSSH4G' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/detonaweb/PWEB/raw/main/PainelWebV5/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/detonaweb/PWEB/raw/main/PainelWebV5/verifatt.sh > /dev/null 2>&1
wget https://github.com/detonaweb/PWEB/raw/main/PainelWebV5/verpweb > /dev/null 2>&1
wget https://github.com/detonaweb/PWEB/raw/main/PainelWebV5/verweb > /dev/null 2>&1
wget https://github.com/detonaweb/PWEB/raw/main/PainelWebV5/whatsapp.sh > /dev/null 2>&1
...
wget https://github.com/detonaweb/PWEB/raw/main/PainelWebV5/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "DETONAWEB V5" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @DETONAWEBSSH4G\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://github.com/detonaweb/PWEB/raw/main/PainelWebV5/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@DETONAWEBSSH4G\033[0m" | lolcat
echo ""
